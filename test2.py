...
def one(input):
	...
	for i in range(len(input)):
		string1 += input[i] + input[i] + input[i]
	return string1
...
def three(a):
	first_num =str(a) + str(a)
	second_num = str(a) + str(a) + str(a)
	third_num = str(a) + str(a) + str(a) + str(a)
	first_num = int(first_num)
	second_num =int(second_num)
	third_num = int(third_num)
	return a + first_num + second_num + third_num
